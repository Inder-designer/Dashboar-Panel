...
import style from './nuggetsRequest.module.scss'
import {
    faMagnifyingGlass,
...
const NuggetsRequest = () => {
  return (
    <div className={` ${style.nuggetsRequest}`}>
            ...
            <Table className="">
                ...
                <Table.Body className="divide-y">
                    <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <Table.Cell className='!text-[#CD6F00]'>Requested</Table.Cell>
                    </Table.Row>
                    <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <Table.Cell className='!text-[#009922]'>Approved</Table.Cell>
                    </Table.Row>
                    <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                        <Table.Cell>8861</Table.Cell>
                        <Table.Cell className='!text-[#5B58E3]'>556</Table.Cell>
