...
const AllTransaction = () => {
  return (
    <div className={` ${style.allTransaction}`}>
            ...
            <Table className="">
                ...
                <Table.Body className="divide-y">
                    <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <Table.Cell>1439</Table.Cell>
                        <Table.Cell>1148</Table.Cell>
                        <Table.Cell>22 Oct, 2020</Table.Cell>
                        <Table.Cell>06:32 pm</Table.Cell>
                        <Table.Cell className='!text-[#CD6F00]'>Pending</Table.Cell>
                    </Table.Row>
                    <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                        <Table.Cell>1148</Table.Cell>
                        <Table.Cell>130</Table.Cell>
                        <Table.Cell>6025</Table.Cell>
                        <Table.Cell>5028</Table.Cell>
                        <Table.Cell>1 Feb, 2020</Table.Cell>
                        <Table.Cell>05:51 am</Table.Cell>
                        <Table.Cell className='!text-[#009922]'>Complete</Table.Cell>
                    </Table.Row>
                    <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                        <Table.Cell>8861</Table.Cell>
                        <Table.Cell>556</Table.Cell>
